...
class TravelsListTest extends TestCase
{
    ...
    public function test_travels_list_show_only_public_records(): void
    {
        ...
        $response->assertJsonPath('data.0.name' , $publicTravel->getAttributeValue('name'));

    }

    public function test_returns_empty_list_when_no_public_travels_exist()
    {
        // Arrange
        Travel::factory()->count(2)->create(['is_public' => false]);
